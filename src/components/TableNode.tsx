          ...
          <div className="space-y-1 px-4 py-2">
            {table.columns &&
              table.columns.map((c) => (
                <div
                  key={c.uuid}
                  className="group relative flex items-center justify-between gap-x-4"
                >
                  <Handle
                    type="source"
                    position={Position.Right}
                    id={c.uuid}
                    className="!bg-primary !h-3 !w-3 opacity-0 transition-opacity group-hover:opacity-100"
                  />
                  <Handle
                    type="target"
                    ...
                    className="!bg-primary !h-3 !w-3 opacity-0 transition-opacity group-hover:opacity-100"
                  />
                  <p className="hover:text-primary cursor-pointer">{c.name}</p>
